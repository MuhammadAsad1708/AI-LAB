...
# Load the dataset
X = pd.read_csv("/Users/muhammadasad/Desktop/ai lab/4/logisticX.csv", header=None)
y = pd.read_csv("/Users/muhammadasad/Desktop/ai lab/4/logisticY.csv", header=None)
